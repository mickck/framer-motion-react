...
function App() {
  ...
  const gradient = useTransform(
    ...
    [-800, 0, 800],
    [
      "linear-gradient(135deg, rgb(248, 247, 183), rgb(194, 112, 80) ",
      "linear-gradient(135deg, rgb(183, 248, 219) , rgb(80, 167, 194) ",
      "linear-gradient(135deg, rgb(211, 183, 248) , rgb(194, 80, 185)",
    ]
  );
  ...
  const svg = {
    ...
    end: { fill: "rgba(255, 255, 255, 1)", pathLength: 1, stroke: "black" },
  };
  return (
